                ...
                <div class="glass-card rounded-2xl p-4 shadow-card">
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-xs text-emerald-600 mt-1">{{ ucfirst($user->role ?? 'Administrator') }}</p>
                        </div>
        ...
        <div class="flex min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50">
            ...
            <!-- ==================== SIDEBAR ==================== -->
                ...
                <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
                    ...
                    <a href="{{ route('pengaturan') }}" class="flex items-center gap-3 px-4 py-3.5 rounded-xl bg-gradient-to-r from-emerald-50 to-teal-50 text-emerald-700 font-semibold transition-all sidebar-link active">
                            ...
                            <div class="glass-card rounded-2xl p-6 shadow-card">
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-sm text-emerald-600 mt-1">{{ ucfirst($user->role ?? 'Administrator') }}</p>
                                    </div>
