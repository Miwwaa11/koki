...
<head>
    ...
    <style>
        ...
        .activity-item-enter:nth-child(1) { animation-delay: 0.1s; }
        .activity-item-enter:nth-child(2) { animation-delay: 0.2s; }
        .activity-item-enter:nth-child(3) { animation-delay: 0.3s; }
        .activity-item-enter:nth-child(4) { animation-delay: 0.4s; }
        .activity-item-enter:nth-child(5) { animation-delay: 0.5s; }
...
<body class="text-slate-800 antialiased wave-pattern">
    ...
    <div class="md:hidden max-w-[414px] mx-auto min-h-screen bg-gradient-to-b from-slate-50 to-white relative shadow-2xl overflow-hidden">
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div class="glass-card rounded-2xl p-4 shadow-card border-l-4 border-emerald-500 card-hover stat-card-enter cursor-pointer btn-press">
                        <div class="flex items-center justify-between mb-3">
                            ...
                            <span class="text-[10px] font-semibold text-emerald-600 bg-emerald-50 px-2 py-1 rounded-full">+<?php echo e($totalIkan); ?> ekor</span>
                        </div>
                        <p class="text-[10px] text-slate-500 font-medium uppercase tracking-wider mb-1">Total Ikan</p>
                        <p class="text-2xl font-extrabold gradient-text"><?php echo e(number_format($totalIkan)); ?></p>
                    ...
                    <div class="glass-card rounded-2xl p-4 shadow-card border-l-4 border-teal-500 card-hover stat-card-enter cursor-pointer btn-press">
                        <div class="flex items-center justify-between mb-3">
                            ...
                            <span class="text-[10px] font-semibold text-teal-600 bg-teal-50 px-2 py-1 rounded-full"><?php echo e($jumlahKolam); ?> unit</span>
                        </div>
                        <p class="text-[10px] text-slate-500 font-medium uppercase tracking-wider mb-1">Jumlah Kolam</p>
                        <p class="text-2xl font-extrabold gradient-text"><?php echo e(number_format($jumlahKolam)); ?></p>
                    ...
                    <div class="glass-card rounded-2xl p-4 shadow-card border-l-4 border-cyan-500 card-hover stat-card-enter cursor-pointer btn-press">
                        ...
                        <p class="text-2xl font-extrabold gradient-text"><?php echo e(number_format($ikanBaru)); ?></p>
                    ...
                    <div class="glass-card rounded-2xl p-4 shadow-card border-l-4 border-emerald-600 card-hover stat-card-enter cursor-pointer btn-press">
                        <div class="flex items-center justify-between mb-3">
                            ...
                            <span class="text-[10px] font-semibold text-emerald-600 bg-emerald-50 px-2 py-1 rounded-full"><?php echo e($jumlahKolam > 0 ? round(($kolamAktif / $jumlahKolam) * 100) : 0); ?>%</span>
                        </div>
                        <p class="text-[10px] text-slate-500 font-medium uppercase tracking-wider mb-1">Kolam Aktif</p>
                        <p class="text-2xl font-extrabold gradient-text"><?php echo e(number_format($kolamAktif)); ?></p>
            ...
            <section class="glass-card rounded-2xl p-5 shadow-card card-hover">
                ...
                <div class="flex justify-between mt-4 pt-4 border-t border-slate-100">
                    <div class="text-center">
                        ...
                        <p class="text-sm font-bold text-emerald-600"><?php echo e($populasiIkan->count() > 0 ? round($populasiIkan->avg('total')) : 0); ?> ekor</p>
                    </div>
                    <div class="text-center">
                        <p class="text-[9px] text-slate-400 mb-1">Tertinggi</p>
                        <p class="text-sm font-bold text-teal-600"><?php echo e($populasiIkan->count() > 0 ? $populasiIkan->max('total') : 0); ?> ekor</p>
                    </div>
                    <div class="text-center">
                        <p class="text-[9px] text-slate-400 mb-1">Terendah</p>
                        <p class="text-sm font-bold text-cyan-600"><?php echo e($populasiIkan->count() > 0 ? $populasiIkan->min('total') : 0); ?> ekor</p>
                    </div>
                </div>
            </section>
            ...
            <section>
                ...
                <div class="glass-card rounded-2xl p-4 shadow-card">
                    <div class="space-y-3" id="activityList">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $aktivitasTerbaru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aktivitas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="flex items-start gap-3 pb-3 border-b border-slate-100 activity-item-enter">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-sm font-semibold text-slate-800 truncate"><?php echo e($aktivitas->jenis_ikan ?? 'Ikan'); ?> - Stok: <?php echo e($aktivitas->stok); ?> ekor</p>
                                <p class="text-[10px] text-slate-400 mt-0.5"><?php echo e($aktivitas->kolam ? $aktivitas->kolam->nama : 'Tanpa Kolam'); ?> • <?php echo e($aktivitas->created_at->diffForHumans()); ?></p>
                            </div>
                        </div>
        ...
        <nav class="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-xl border-t border-slate-200 px-6 py-3 pb-6 z-40 max-w-[414px] mx-auto shadow-soft">
            <div class="flex justify-around items-center">
                <!-- Dashboard (Active) -->
                <a href="<?php echo e(route('dashboard')); ?>" class="flex flex-col items-center gap-1.5 nav-item nav-item-active transition-all duration-300 btn-press">
        ...
        <div class="flex min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50">
            ...
            <aside class="sidebar-width bg-white border-r border-slate-200 flex flex-col fixed h-full shadow-elegant z-50">
                ...
                <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
                    <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-3 px-4 py-3.5 rounded-xl bg-gradient-to-r from-emerald-50 to-teal-50 text-emerald-700 font-semibold transition-all sidebar-link active">
                    ...
                    <div class="grid grid-cols-4 gap-6 mb-8">
                        <div class="glass-card rounded-2xl p-6 shadow-card border-l-4 border-emerald-500 card-hover">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <span class="text-xs font-semibold text-emerald-600 bg-emerald-50 px-3 py-1 rounded-full">+<?php echo e($totalIkan); ?> ekor</span>
                            </div>
                            <p class="text-xs text-slate-500 font-medium uppercase tracking-wider mb-2">Total Ikan</p>
                            <p class="text-3xl font-extrabold gradient-text"><?php echo e(number_format($totalIkan)); ?></p>
                        </div>
                        ...
                        <div class="glass-card rounded-2xl p-6 shadow-card border-l-4 border-teal-500 card-hover">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <span class="text-xs font-semibold text-teal-600 bg-teal-50 px-3 py-1 rounded-full"><?php echo e($jumlahKolam); ?> unit</span>
                            </div>
                            <p class="text-xs text-slate-500 font-medium uppercase tracking-wider mb-2">Jumlah Kolam</p>
                            <p class="text-3xl font-extrabold gradient-text"><?php echo e(number_format($jumlahKolam)); ?></p>
                        </div>
                        ...
                        <div class="glass-card rounded-2xl p-6 shadow-card border-l-4 border-cyan-500 card-hover">
                            ...
                            <p class="text-3xl font-extrabold gradient-text"><?php echo e(number_format($ikanBaru)); ?></p>
                        </div>
                        ...
                        <div class="glass-card rounded-2xl p-6 shadow-card border-l-4 border-emerald-600 card-hover">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <span class="text-xs font-semibold text-emerald-600 bg-emerald-50 px-3 py-1 rounded-full"><?php echo e($kolamAktif); ?>/<?php echo e($jumlahKolam); ?> aktif</span>
                            </div>
                            <p class="text-xs text-slate-500 font-medium uppercase tracking-wider mb-2">Kolam Aktif</p>
                            <p class="text-3xl font-extrabold gradient-text"><?php echo e($kolamAktif); ?>/<?php echo e($jumlahKolam); ?></p>
                        </div>
                    </div>
                        ...
                        <div class="glass-card rounded-2xl p-6 shadow-card">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-start gap-3 pb-3 border-b border-slate-100">
                                    ...
                                    <div>
                                        <p class="text-sm font-semibold text-slate-800"><?php echo e($aktivitas->jenis_ikan ?? 'Ikan'); ?> - Stok: <?php echo e($aktivitas->stok); ?> ekor</p>
                                        <p class="text-[10px] text-slate-400"><?php echo e($aktivitas->kolam ? $aktivitas->kolam->nama : 'Tanpa Kolam'); ?> • <?php echo e($aktivitas->created_at->diffForHumans()); ?></p>
                                    </div>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <div class="text-center py-8">
    ...
    <script>
        ...
        function initChart() {
            ...
            // Data dari database
            const chartData = <?php echo json_encode($populasiIkan, 15, 512) ?>;
...
<?php /**PATH C:\xampp1\htdocs\projek-ikan-koki\resources\views/auth/dashboard.blade.php ENDPATH**/ ?>