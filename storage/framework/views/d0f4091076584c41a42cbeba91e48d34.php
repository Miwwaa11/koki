    ...
    <div class="md:hidden">
        ...
        <nav class="bg-white border-b border-slate-200 px-6 py-4 sticky top-0 z-40 shadow-soft">
            <div class="flex justify-between items-center">
                <img src="<?php echo e(asset('images/alfin2.png')); ?>" alt="Logo" class="w-32 h-auto object-contain">
        ...
        <nav class="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-xl border-t border-slate-200 px-6 py-3 pb-6 z-40 max-w-[414px] mx-auto shadow-soft">
            <div class="flex justify-around items-center">
                <!-- Dashboard -->
                <a href="<?php echo e(route('dashboard')); ?>" class="flex flex-col items-center gap-1.5 nav-item text-slate-400 hover:text-emerald-600 transition-all duration-300 btn-press <?php echo e(request()->routeIs('dashboard') ? 'nav-item-active' : ''); ?>">
                ...
                <!-- Ikan -->
                <a href="<?php echo e(route('ikan.index')); ?>" class="flex flex-col items-center gap-1.5 nav-item text-slate-400 hover:text-emerald-600 transition-all duration-300 btn-press <?php echo e(request()->routeIs('ikan.*') ? 'nav-item-active' : ''); ?>">
                ...
                <!-- Kolam -->
                <a href="<?php echo e(route('kolam.index')); ?>" class="flex flex-col items-center gap-1.5 nav-item text-slate-400 hover:text-emerald-600 transition-all duration-300 btn-press <?php echo e(request()->routeIs('kolam.*') ? 'nav-item-active' : ''); ?>">
                    <div class="nav-icon w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 hover:bg-emerald-50">
                ...
                <!-- Akun -->
                <a href="<?php echo e(route('akun')); ?>" class="flex flex-col items-center gap-1.5 nav-item text-slate-400 hover:text-emerald-600 transition-all duration-300 btn-press <?php echo e(request()->routeIs('akun') ? 'nav-item-active' : ''); ?>">
                    <div class="nav-icon w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 hover:bg-emerald-50">
        ...
        <div class="flex min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50">
            ...
            <aside class="sidebar-width bg-white border-r border-slate-200 flex flex-col fixed h-full shadow-elegant z-50">
                ...
                <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
                    <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-3 px-4 py-3.5 rounded-xl <?php echo e(request()->routeIs('dashboard') ? 'bg-gradient-to-r from-emerald-50 to-teal-50 text-emerald-700 font-semibold' : 'text-slate-600 hover:bg-slate-50'); ?> transition-all sidebar-link <?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>">
                        <i class="fas fa-home w-5"></i>
                        <span>Dashboard</span>
                    </a>
                    
                    <a href="<?php echo e(route('ikan.index')); ?>" class="flex items-center gap-3 px-4 py-3.5 rounded-xl <?php echo e(request()->routeIs('ikan.*') ? 'bg-gradient-to-r from-emerald-50 to-teal-50 text-emerald-700 font-semibold' : 'text-slate-600 hover:bg-slate-50'); ?> transition-all sidebar-link <?php echo e(request()->routeIs('ikan.*') ? 'active' : ''); ?>">
                        <i class="fas fa-fish w-5"></i>
                        <span>Data Ikan</span>
                    </a>
                    
                    <a href="<?php echo e(route('kolam.index')); ?>" class="flex items-center gap-3 px-4 py-3.5 rounded-xl <?php echo e(request()->routeIs('kolam.*') ? 'bg-gradient-to-r from-emerald-50 to-teal-50 text-emerald-700 font-semibold' : 'text-slate-600 hover:bg-slate-50'); ?> transition-all sidebar-link <?php echo e(request()->routeIs('kolam.*') ? 'active' : ''); ?>">
                        <i class="fas fa-water w-5"></i>
                        <span>Data Kolam</span>
                    </a>
                    
                    <a href="<?php echo e(route('akun')); ?>" class="flex items-center gap-3 px-4 py-3.5 rounded-xl <?php echo e(request()->routeIs('akun') ? 'bg-gradient-to-r from-emerald-50 to-teal-50 text-emerald-700 font-semibold' : 'text-slate-600 hover:bg-slate-50'); ?> transition-all sidebar-link <?php echo e(request()->routeIs('akun') ? 'active' : ''); ?>">
                        <i class="fas fa-user w-5"></i>
                        <span>Akun Admin</span>
                    </a>

                    <a href="<?php echo e(route('pengaturan')); ?>" class="flex items-center gap-3 px-4 py-3.5 rounded-xl <?php echo e(request()->routeIs('pengaturan') ? 'bg-gradient-to-r from-emerald-50 to-teal-50 text-emerald-700 font-semibold' : 'text-slate-600 hover:bg-slate-50'); ?> transition-all sidebar-link <?php echo e(request()->routeIs('pengaturan') ? 'active' : ''); ?>">
...
<?php /**PATH C:\xampp1\htdocs\projek-ikan-koki\resources\views/layouts/dashboard-layout.blade.php ENDPATH**/ ?>