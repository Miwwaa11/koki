    ...
    <div class="md:hidden max-w-[414px] mx-auto min-h-screen bg-gradient-to-b from-slate-50 to-white relative shadow-2xl overflow-hidden">
        ...
        <main class="px-5 py-6 pb-24 space-y-5">
            ...
            <div class="glass-card rounded-2xl p-5 shadow-card">
                <form action="<?php echo e(route('kolam.store')); ?>" method="POST" class="space-y-5">
                    <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_kolam" value="<?php echo e(old('nama_kolam')); ?>" placeholder="Contoh: Kolam A1" class="w-full px-4 py-3 rounded-xl border border-slate-200 bg-white/70 focus:bg-white transition-colors <?php $__errorArgs = ['nama_kolam'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <input type="number" name="kapasitas" value="<?php echo e(old('kapasitas')); ?>" placeholder="120" class="w-full px-4 py-3 rounded-xl border border-slate-200 bg-white/70 focus:bg-white <?php $__errorArgs = ['kapasitas'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="ukuran" value="<?php echo e(old('ukuran')); ?>" placeholder="Contoh: 3x4m, 12m²" class="w-full px-4 py-3 rounded-xl border border-slate-200 bg-white/70 focus:bg-white transition-colors">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="lokasi" value="<?php echo e(old('lokasi')); ?>" placeholder="Contoh: Area A, Gedung 1" class="w-full px-4 py-3 rounded-xl border border-slate-200 bg-white/70 focus:bg-white transition-colors">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <input type="number" name="suhu" value="<?php echo e(old('suhu')); ?>" placeholder="26" step="0.01" min="0" max="100" class="w-full px-4 py-3 rounded-xl border border-slate-200 bg-white/70 focus:bg-white transition-colors <?php $__errorArgs = ['suhu'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-4">
                            <label class="flex items-center gap-2">
                                <input type="radio" name="status" value="aktif" class="w-4 h-4 text-emerald-600" <?php echo e(old('status', 'aktif') == 'aktif' ? 'checked' : ''); ?> required>
                                <span class="text-sm">Aktif</span>
                            </label>
                            <label class="flex items-center gap-2">
                                <input type="radio" name="status" value="nonaktif" class="w-4 h-4 text-emerald-600" <?php echo e(old('status') == 'nonaktif' ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="grid grid-cols-2 gap-3 pt-3">
                        ...
                        <button type="button" onclick="window.location.href='<?php echo e(route('kolam.index')); ?>'" class="py-3 rounded-xl bg-slate-100 text-slate-600 font-semibold hover:bg-slate-200 transition-all btn-press">
                    ...
                    <div class="glass-card rounded-2xl p-8 shadow-card">
                        <form class="space-y-6">
                            ...
                            <div class="bg-emerald-50 p-4 rounded-xl">
                                ...
                                <div class="grid grid-cols-3 gap-4">
                                    <div>
                                        ...
                                        <input type="number" name="suhu" value="<?php echo e(old('suhu', 26)); ?>" step="0.01" min="0" max="100" class="w-full px-4 py-2 rounded-lg border border-emerald-200 bg-white focus:bg-white">
                                    </div>
                                    <div>
                            ...
                            <div class="flex gap-3 pt-4">
                                ...
                                <button type="button" onclick="window.location.href='<?php echo e(route('kolam.index')); ?>'" class="px-8 py-3 rounded-xl bg-slate-100 text-slate-600 font-semibold hover:bg-slate-200 transition-all btn-press">
...
<?php /**PATH C:\xampp1\htdocs\projek-ikan-koki\resources\views/auth/tambah-kolam.blade.php ENDPATH**/ ?>