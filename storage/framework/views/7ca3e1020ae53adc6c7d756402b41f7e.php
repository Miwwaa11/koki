...
<body class="font-sans antialiased bg-gradient-to-br from-emerald-700 via-teal-600 to-cyan-600 min-h-screen flex items-center justify-center relative overflow-x-hidden p-4">
  ...
  <div class="absolute inset-0 overflow-hidden pointer-events-none z-0">
    ...
    <svg class="absolute bottom-0 left-0 w-full text-white/10" viewBox="0 0 1440 200" preserveAspectRatio="none">
      ...
      <div class="w-full md:w-1/2 p-8 md:p-10">
        ...
        <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-5">
          ...
          <div>
            ...
            <input type="email" name="email" placeholder="admin@kokifarm" value="<?php echo e(old('email')); ?>" class="w-full px-5 py-3.5 rounded-xl border border-gray-200 bg-white/70 focus:bg-white transition-colors placeholder:text-gray-400 text-gray-800 text-base <?php $__errorArgs = ['email'];
...
$message = $__bag->first($__errorArgs[0]); ?>
              <p class="text-red-500 text-xs mt-1 ml-1"><?php echo e($message); ?></p>
            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          ...
          <div class="relative">
            ...
            <div class="relative">
              <input type="password" id="passwordField" name="password" placeholder="••••••••" class="w-full px-5 py-3.5 rounded-xl border border-gray-200 bg-white/70 focus:bg-white pr-12 transition-colors placeholder:text-gray-400 text-gray-800 text-base <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
      ...
      <div class="hidden md:flex w-1/2 bg-white relative overflow-hidden">
        ...
        <div class="absolute -left-12 bottom-12 w-32 h-32 bg-gradient-to-tr from-cyan-100 to-teal-100 rounded-full blur-3xl opacity-50"></div>
        ...
        <!-- Logo besar -->
        <img src="<?php echo e(asset('images/alfin1.png')); ?>" alt="Alfin Aquatic Logo" class="absolute inset-0 w-3/4 h-3/4 object-contain z-10 m-auto">
      </div>
...
</html><?php /**PATH C:\xampp1\htdocs\projek-ikan-koki\resources\views/login.blade.php ENDPATH**/ ?>