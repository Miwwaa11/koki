      ...
      <div class="w-full md:w-1/2 p-8 md:p-10">
        ...
        <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-5">
          ...
          <div>
            ...
            <input type="email" name="email" placeholder="admin@kokifarm" value="<?php echo e(old('email')); ?>" class="w-full px-5 py-3.5 rounded-xl border bg-white/70 focus:bg-white pr-12 transition-colors placeholder:text-gray-400 text-gray-800 text-base" style="border-color: <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> #ef4444 <?php else: ?> #d1d5db <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          ...
          <div class="relative">
            ...
            <div class="relative">
              <input type="password" id="passwordField" name="password" placeholder="••••••••" class="w-full px-5 py-3.5 rounded-xl border bg-white/70 focus:bg-white pr-12 transition-colors placeholder:text-gray-400 text-gray-800 text-base" style="border-color: <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> #ef4444 <?php else: ?> #d1d5db <?php unset($message);
...
<?php /**PATH C:\xampp1\htdocs\projek-ikan-koki\resources\views/auth/login.blade.php ENDPATH**/ ?>